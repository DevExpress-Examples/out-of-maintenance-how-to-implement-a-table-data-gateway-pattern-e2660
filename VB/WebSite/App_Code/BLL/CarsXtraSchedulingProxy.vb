...
Public NotInheritable Class CarsXtraSchedulingProxy
	...
	Public Shared Function UpdateAppointment(ByVal CarId As String, ByVal Status As Nullable(Of Integer), ByVal Subject As String, ByVal Description As String, ByVal Label As Nullable(Of Integer), ByVal StartTime As Nullable(Of DateTime), ByVal EndTime As Nullable(Of DateTime), ByVal Location As String, ByVal AllDay As Boolean, ByVal EventType As Nullable(Of Integer), ByVal RecurrenceInfo As String, ByVal ReminderInfo As String, ByVal Price As Nullable(Of Decimal), ByVal ID As Integer) As Boolean
